...
export default function SignUpPage() {
  ...
  return (
    <div className="w-full flex-1 flex items-center justify-center p-4">
      ...
      >
        {/* Glow effect */}
        <div className="absolute top-0 left-0 -ml-16 -mt-16 w-32 h-32 rounded-full bg-blue-500/20 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-0 -mr-16 -mb-16 w-32 h-32 rounded-full bg-emerald-500/20 blur-3xl pointer-events-none" />

        <div className="relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white tracking-wide">Create Account</h2>
            <p className="text-white/60 mt-2">Join Agrovanta to ensure food safety</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-6">
            ...
            <motion.button
              ...
              disabled={loading}
              type="submit"
              className="w-full py-3.5 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl font-semibold shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all duration-300 disabled:opacity-70 flex justify-center items-center"
            >
              {loading ? (
